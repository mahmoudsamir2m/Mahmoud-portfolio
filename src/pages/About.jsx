...
import { Code2, Monitor, Smartphone, Database, Server, Palette, FileText, Download, X } from 'lucide-react';
import { useState } from 'react';
import cvFile from '../assets/Mahmoud-Samir-CV.pdf';
import meImg from '../assets/me.jpg';

const skills = [
  { name: 'Frontend', icon: <Monitor size={24} />, desc: 'React, Next.js, HTML/CSS/JS/TS, Tailwind' },
  { name: 'Other', icon: <Code2 size={24} />, desc: 'Git, GitHub, Responsive Design, Problem Solving' },
];

const technologies = ['React', 'Next.js', 'Tailwind CSS', 'Framer Motion', 'TypeScript', 'Redux','zustand','Context','react-hook-form','Zod','......'];
      ...
      >
        ...
        <div className="flex flex-col md:flex-row gap-12 items-center md:items-start mb-16 border-b border-white/5 pb-16">
          <div className="w-48 h-48 md:w-64 md:h-64 shrink-0 rounded-2xl bg-dark-800 border border-white/10 overflow-hidden shadow-xl flex items-center justify-center">
            <img src={meImg} alt="Mahmoud Samir" className="w-full h-full object-cover" />
          </div>
          
          <div className="flex-grow space-y-4 text-lg text-slate-400">
            <p>
  Hi, I'm Mahmoud Samir — a passionate Frontend Developer who enjoys turning ideas into interactive and user-friendly web applications.
  I specialize in building modern interfaces using React and Next.js, focusing on performance, scalability, and clean code.
</p>

<p>
  I love creating seamless user experiences with technologies like TypeScript, Tailwind CSS, and modern UI libraries.
  My goal is always to write maintainable code and build products that are both visually appealing and technically solid.
</p>

<p>
  Currently, I'm expanding my skills in full-stack development and continuously exploring new tools and best practices to become a better developer every day.
</p>
            <div className="pt-4">
              <button 
      ...
      >
        <h2 className="text-2xl font-bold mb-6 text-white">Technologies I Use</h2>
